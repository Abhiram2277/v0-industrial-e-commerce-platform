            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-sm font-semibold mb-4">
                  💡 Need a product quote? <a href="https://wa.me/918978338552" target="_blank" rel="noopener noreferrer" className="text-green-600 font-bold underline hover:text-green-700 transition-colors">WhatsApp us</a> for instant response.
                </p>
                <ContactForm />
              </div>
